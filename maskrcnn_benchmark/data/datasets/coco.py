...
class COCODataset(torchvision.datasets.coco.CocoDetection):
    def __init__(
        ...
        self.proposal_dir = extra_args['EXT_PROPOSAL_DIR']
    ...
    def __getitem__(self, idx):
        ...
        target = BoxList(boxes, img.size, mode="xywh").convert("xyxy") # original size
        ...
        if self._transforms is not None:
            img, target = self._transforms(img, target)  # resized
